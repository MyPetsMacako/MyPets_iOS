...
class Map_ViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    func updateButtonState() {
        ...
        switch isVetsEnable {
        case true:
            vetsButton.backgroundColor = backgroundColorHighlighted
        ...
        case true:
            storesButton.backgroundColor = backgroundColorHighlighted
        ...
        case true:
            parksButton.backgroundColor = backgroundColorHighlighted
